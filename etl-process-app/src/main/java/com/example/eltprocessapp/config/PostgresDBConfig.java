...
@EnableJpaRepositories(entityManagerFactoryRef = "postgresEntityManagerFactory", basePackages = {"com.example.eltprocessapp.postgres.repository"}, transactionManagerRef = "postgresTransactionManager")
public class PostgresDBConfig {
    ...
    public LocalContainerEntityManagerFactoryBean dataDbEntityManagerFactory(EntityManagerFactoryBuilder builder,
        ...
        return builder.dataSource(dataSource).properties(properties)
                .packages("com.example.eltprocessapp.postgres.entity")
                .persistenceUnit("datadb").build();
    }
